      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h1 className="font-display text-4xl md:text-5xl font-bold">
            <span className="gradient-purple-pink-text">Plano de Ação</span>
          </h1>
          <p className="text-gray-300 font-body mt-3">
            Um roteiro prático de 30 dias para conquistar seus primeiros clientes.
          </p>
        </div>
        <ActionPlan />
              ...
              onClick={() => {
                try {
                  ...
                  if (typeof g === 'function') {
                    g('event', 'cta_click', { variant: 'Começar Agora – PlanoAcao', page_path: window.location.pathname });
                  }
                } catch {}
              }}
            >
            ...
            <a
              ...
              onClick={() => {
                try {
                  const g = (window as any).gtag;
                  if (typeof g === 'function') {
                    g('event', 'cta_click', { variant: 'Voltar aos Sites – PlanoAcao', page_path: window.location.pathname });
                  }
                } catch {}
              }}
            >
            ...
            <button
              ...
              onClick={() => {
                try {
                  ...
                  const g = (window as any).gtag;
                  if (typeof g === 'function') {
                    g('event', 'share_click', { variant: 'Compartilhar – PlanoAcao', page_path: window.location.pathname });
                  }
                } catch {}
              }}
            >
